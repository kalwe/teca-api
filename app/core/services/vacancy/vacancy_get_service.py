...
from app.core.repositories.vacancy.vacancy_get_repository import (
    VacancyGetRepository)
...
class VacancyGetService(GetService):
    ...
    async def get_all(self, filters: Optional[dict] = None
        ...
        vacancys = self.get_all_records(filters)
        return [VacancyOutputSchema.validate(vacancy) for vacancy in vacancys]
