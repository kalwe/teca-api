...
class ReminderBaseSchema(BaseSchema):
    """
...
class ReminderInputSchema(ReminderBaseSchema, InputBaseSchema):
   pass

class ReminderOutputSchema(ReminderBaseSchema, OutputBaseSchema):
   pass
